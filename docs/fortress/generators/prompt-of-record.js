...
(function(){var a=Array.isArray(__w)?__w:[__w];for(var i=0;i<a.length;i++){var o=a[i]&&a[i].json?a[i].json:a[i];if(!o||typeof o!=='object')continue;var bk=null,bl=0;for(var kk in o){if(typeof o[kk]==='string'&&o[kk].length>bl){bl=o[kk].length;bk=kk;}}if(bk&&bl>400){o[bk]=o[bk]+__PRICING_BRIEF+__PROOF;o.pricing_total=__p.tot;o.pricing_class=__p.k;}}})();
return __w;
